Shader "URPToon/Lit Transparent Blur (With Outline)"
{
    Properties
    {
        [Header(Base Color)]
        ...
        [HideIf(_ToonDiffuseMuit,0,_LIGHT,1)]_CelShadeSoftness("_CelShadeSoftness", Range(0,1)) = 0.05
    ...
    {       
        ...
        {               
            ...
            #pragma fragment BaseColorPassFragment_TransparentBlur 
        ...
        Pass
        {
            ...
            #pragma fragment ShadowCasterPassFragment_Transparent
            #include "URPToonLit_ShaderFunction.hlsl"            
        ...
        UsePass "URPToon/Lit (With Outline)/DEPTHONLY"
    }
